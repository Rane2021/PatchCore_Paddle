...
def parse_args():
    ...
    parser.add_argument("-i", "--input_file", type=str, help="input file path", 
                         default="/media/tianru/Rane/CODE/04_huagong_proj/PatchCore_Dataset/ori_data/172.16.236.123_0608_crop")  # --> 006 score：3.466
    
    
    parser.add_argument("--model_name", type=str, default="PatchCore")
    parser.add_argument("--model_file", type=str, default="output/coreset_resnet18_10/model.pdmodel")
